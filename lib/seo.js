...
export function generateMetadata({ title, description, image, url }) {
    const siteName = 'Olemwa Chess Club CMS';
    const defaultDescription = 'Official website of the Olemwa Chess Club';
